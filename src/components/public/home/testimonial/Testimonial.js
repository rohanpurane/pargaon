...
import userPic from '../../../../media/gita.png';
...
const TestiMonials = () => {
    ...
    return (
        <section id="testimonial" className="testimonials pt-5 pb-70">
            <div className="container mt-5">
                {testimonialData.map((card, i) => {
                  return (
                    <div className="text-center " key={i}>
                        <h3 className="Title">{currentLang.language === "mr" ? card.heading1_mr : card.heading1_en}</h3>
                    </div>
                  )
                })}
                <div className="row">
